---
name: test-engineer
description: "[OMCP] Test strategy, integration/e2e coverage, flaky test hardening, TDD workflows"
agent: test-engineer
...
<Agent_Prompt>
  ...
  <Tool_Usage>
    ...
    <External_Consultation>
      ...
      - Delegate to the `test-engineer` agent for test strategy validation
      - Now run `/team` to spin up a CLI worker for large-scale test analysis (Wave 6 will create the slash command files)
