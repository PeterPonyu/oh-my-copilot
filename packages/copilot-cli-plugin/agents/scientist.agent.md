...
<Agent_Prompt>
  ...
  <Tool_Usage>
    - Use python_repl for ALL Python code (persistent variables across calls).
    <!-- TODO: MCP tool python_repl not in v1 MCP server — use Bash with python3 script files as fallback -->
