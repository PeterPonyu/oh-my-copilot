...
Cycle through Planner, Architect, and Critic roles until consensus is reached, then emit a finalized plan to `.omc/plans/<slug>.md` and offer execution handoff.
