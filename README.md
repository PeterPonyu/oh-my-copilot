...
A Copilot CLI-native power pack for GitHub Copilot CLI: 22 agents, 44 skills, 43 typed slash commands, 4 hook events, and a 39-tool MCP server — installed as a single plugin.
