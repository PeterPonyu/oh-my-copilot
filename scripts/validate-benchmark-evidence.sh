...
require_file benchmark/results/quick-baseline-20260420T161903Z/quick_results.json
require_file benchmark/results/quick-agent-smoke-20260420T161903Z/quick_results.json
require_file benchmark/results/full-agent-smoke-20260420T161903Z/full_results.json
...
baseline = check_all_pass(
    "benchmark/results/quick-baseline-20260420T161903Z/quick_results.json",
    4,
    "quick-baseline",
)
enhanced = check_all_pass(
    "benchmark/results/quick-agent-smoke-20260420T161903Z/quick_results.json",
    4,
    "quick-agent-smoke",
)
full = check_all_pass(
    "benchmark/results/full-agent-smoke-20260420T161903Z/full_results.json",
    7,
    "full-agent-smoke",
)
