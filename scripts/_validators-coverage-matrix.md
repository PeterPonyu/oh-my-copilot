...
Overlap: `validate-power-surfaces.sh` calls `validate-cross-host-benchmark-data.mjs`; `validate-release-readiness.sh` calls this as a sub-step. All benchmark-JSON assertions are unique.
