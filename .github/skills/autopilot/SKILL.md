---
name: autopilot
description: "[OMCP] Full autonomous execution from idea to working code"
orchestrates-agents: "analyst, architect, critic, executor, verifier, security-reviewer, code-reviewer"
...
This skill is an orchestration workflow over custom-agent roles, not a standalone
agent. It coordinates `analyst`, `architect`, `critic`, `executor`, `verifier`,
`security-reviewer`, and `code-reviewer` roles across expansion, planning,
execution, QA, and validation phases.
