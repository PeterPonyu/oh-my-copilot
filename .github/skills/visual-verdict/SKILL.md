---
name: visual-verdict
description: "[OMCP] Structured visual QA verdict for screenshot-to-reference comparisons"
level: 2
---
...
- If `score < 90`, continue editing and rerun `/omcp:visual-verdict` before any further visual review pass.
